...
grid.arrange(grobs= list(SCZ_GTExV6, SCZ_GTExv7, qqgtex6, qqgtex7), nrows=2, top=textGrob("Schizophrenia Gene-Tissue Associations", gp=gpar(fontsize=20, fontface="bold")))
