...
tissue<-fread("Z://wl3backup/gtex7_scz_assoc/AllTissueAssociationGTExVersion7.txt",header = TRUE, stringsAsFactors = TRUE)
#Read in GTEx V7
...
plot1<-grid.arrange(grobs= list(SCZ_GTExv7, qqgtex7), ncols=2, nrow=1)
#ggsave("Z://wl3backup/figure1_qqman.eps", plot = plot1, width = 25, height = 12.5,units = "cm", dpi = 600)
ggsave("Z://wl3backup/figure1_qqman2.pdf", plot = plot1, width = 14, height = 7, units = "in")

png("Z://wl3backup/SCZ_man7_Figure1.png", width=2998, height = 1499, res = 300)
grid.arrange(grobs= list(SCZ_GTExv7, qqgtex7), ncols=2, nrow=1)
dev.off()

pdf("Z://wl3backup/SCZ_man7_Figure1.pdf", width=12.50, height = 6.25, compress = T)
grid.arrange(grobs= list(SCZ_GTExv7, qqgtex7), ncols=2, nrow=1)
dev.off()
...
plot2<- grid.arrange(grobs= list(BP_GTEx7,bpqq), ncol=2)
#dev.off()
ggsave("Z://wl3backup/figure4_qqman.pdf", plot = plot2, width = 14, height = 7, units = "in")
